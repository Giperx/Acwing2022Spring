...
int main() 
{
    ...
    scanf("%lf", &n);
    double l = 0, r = n;
    if (r < 0) swap(l, r);  //负数情况，答案在n-0之间

    if (n > -1 && n < 1)    //BUG特判一下就好了
    {//比如：0.001,显而易见答案是0.1，不在[0, 0.001]中的
        l = -1;
        r = 1;
    }

    while (r - l > 1e-8)    //当区间很小时，近似得出答案，取l或者r都行
    {
        double mid = (l + r) / 2.0;
...
<img src="ForImage/image-20240323222144860.png" alt="image-20240323222144860" style="zoom: 67%;" />
